...
parser.add_argument("-p1", "--plot-path1") # Better not to do like this, but why not
...
parser.add_argument("-p6", "--plot-path6")
plot_pathes = [parser.parse_args().plot_path1, parser.parse_args().plot_path2, parser.parse_args().plot_path3,
               parser.parse_args().plot_path4, parser.parse_args().plot_path5, parser.parse_args().plot_path6]
